...
public class frmGestionSalas extends javax.swing.JFrame {
    ...
    public frmGestionSalas(String rolUsuario, int idUsuario) {
        this.rolUsuario = rolUsuario; // Guardamos el rol
        this.idUsuario = idUsuario;
        initComponents();
        setLocationRelativeTo(null); // Centrar ventana
        
        // Puedes mostrar el ID o el rol en consola para verificar
    System.out.println("ID usuario: " + idUsuario);
    System.out.println("Rol usuario: " + rolUsuario);
    }
    
    private void abrirDialogReserva(int idSala, String nombreSala) {
        dlgReservaSala dialog = new dlgReservaSala(this, idSala, nombreSala, idUsuario);
    ...
    private void initComponents() {
        ...
        botonSalaProgramacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonSalaProgramacionActionPerformed(evt);
            }
        });
        ...
        botonSalaEdicionVideo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonSalaEdicionVideoActionPerformed(evt);
            }
        });
        ...
        botonSalaMultimedia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonSalaMultimediaActionPerformed(evt);
            }
        });
        ...
        botonSalaImformaticaGeneral.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonSalaImformaticaGeneralActionPerformed(evt);
            }
        });
    ...
    private void botonSalaDisenoGraficoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalaDisenoGraficoActionPerformed
        // TODO add your handling code here:
        abrirDialogReserva(1, "Sala Diseño Gráfico");
    }//GEN-LAST:event_botonSalaDisenoGraficoActionPerformed

    private void botonSalaProgramacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalaProgramacionActionPerformed
        // TODO add your handling code here
            abrirDialogReserva(2, "Sala Programación");
    }//GEN-LAST:event_botonSalaProgramacionActionPerformed

    private void botonSalaEdicionVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalaEdicionVideoActionPerformed
        // TODO add your handling code here:
        abrirDialogReserva(3, "Sala Edición de Video");
    }//GEN-LAST:event_botonSalaEdicionVideoActionPerformed

    private void botonSalaMultimediaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalaMultimediaActionPerformed
        // TODO add your handling code here:
        abrirDialogReserva(4, "Sala Multimedia");

    }//GEN-LAST:event_botonSalaMultimediaActionPerformed

    private void botonSalaImformaticaGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalaImformaticaGeneralActionPerformed
        // TODO add your handling code here:
        abrirDialogReserva(5, "Sala Informática General");
    }//GEN-LAST:event_botonSalaImformaticaGeneralActionPerformed
