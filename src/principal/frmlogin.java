...
public class frmlogin extends javax.swing.JFrame {
    ...
    private void botonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarSesionActionPerformed
        ...
        if (usuario != null) {
            ...
            JOptionPane.showMessageDialog(this, "Bienvenido UDI-ISTA " + usuario.getNombre() + " (" + rol + ")");
            ...
            if ( rol.equalsIgnoreCase("administrador")){
                ...
                //Abre ventana de gestion de salas pasando rol e id
                frmGestionSalas gestionSalas = new frmGestionSalas(rol, usuario.getId());
                gestionSalas.setVisible(true);
            }else {   
                  // Estudiantes y administrativos no pueden reservar sala
                  frmroles rolesForm = new frmroles(rol);
